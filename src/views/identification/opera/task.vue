 ...
 * @Last Modified time: 2021-03-18 15:02:07
 */
<template>
    <div class="app-container">
		...
		<el-table ref="multipleTable" :data="list" :height="height" border fit highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中">
			...
			<el-table-column align="center" label="作业名称	" prop="workName"></el-table-column>
			<el-table-column align="center" label="类别" prop="type"></el-table-column>
			<el-table-column align="center" label="频次" prop="frequency"></el-table-column>
        ...
        <!-- 新增 -->
		<el-drawer title="新增作业活动" :visible.sync="addDrawerVisible" :direction="direction" size="25%" :before-close="handleClose">
			<div class="form-box">
				<el-form ref="form" :model="sizeForm" label-width="120px" size="mini">
					...
					<el-form-item label="作业类别">
						<el-select v-model="sizeForm.region" placeholder="请选择作业类别">
							<el-option label="生产作业" value="1"></el-option>
							<el-option label="特种作业" value="2"></el-option>
						</el-select>
					</el-form-item>
                    <el-form-item label="作业频次">
						<el-select v-model="sizeForm.region" placeholder="请选择作业频次">
							<el-option label="每天工作时间内暴露" value="1"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item label="所属部门">
						<el-select v-model="sizeForm.region" placeholder="请选择所属部门">
        ...
        <!-- 导入模板 -->
		<el-dialog class="importTemDialog" title="导入作业活动模板" :visible.sync="importTemVisible" :close-on-click-modal="false" :close-on-press-escape="false" top="15%" width="600px" lock-scroll>
			<el-row>
				<label>作业活动：</label>
				<el-select v-model="importTemParam.temIds" multiple placeholder="请选择">
					<el-option
