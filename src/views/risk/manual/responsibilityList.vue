 ...
 * @Last Modified time: 2021-03-27 16:36:29
 */
  <template>
    <div v-bind:style="{height: height}" class="box">
		...
		<el-table ref="multipleTable" :data="list" :height="tableHeight" border fit highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中">
			...
			<el-table-column align="center" label="现有风险等级" prop="dept"></el-table-column>
			<el-table-column align="center" label="管控层级" prop="dept"></el-table-column>
			<el-table-column align="center" label="责任部门" prop="dept"></el-table-column>
			<el-table-column align="center" label="责任岗位" prop="dept"></el-table-column>
		</el-table>
