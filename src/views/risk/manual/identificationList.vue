 ...
 * @Last Modified time: 2021-03-27 16:37:17
 */
  <template>
    <div v-bind:style="{height: height}" class="box">
		...
		<el-table ref="multipleTable" :data="list" :height="tableHeight" border fit highlight-current-row v-loading="listLoading" element-loading-text="拼命加载中">
			...
			<el-table-column align="center" label="评估方法" prop="dept"></el-table-column>
            <el-table-column align="center" label="固有风险评估">
                <el-table-column align="center" label="风险等级" prop="dept"></el-table-column>
                <el-table-column align="center" label="风险值" prop="dept"></el-table-column>
            </el-table-column>
            <el-table-column align="center" label="现有风险评估">
                <el-table-column align="center" label="风险等级" prop="dept"></el-table-column>
                <el-table-column align="center" label="风险值" prop="dept"></el-table-column>
            </el-table-column>
		</el-table>
