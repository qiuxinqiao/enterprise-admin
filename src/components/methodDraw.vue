/*
 * @Author: qiaozp 
 * @Date: 2021-04-14 14:51:29 
 * @Last Modified by: qiaozp
 * @Description: 月份范围选择
 * @Last Modified time: 2021-04-14 17:36:23
 */

<template>
  <div class="method-draw">
    <div id="svg_editor">
...
<div id="menu_bar">
 <div class="menu">
    ...
    <div class="menu_list" id="file_menu"> 
      <div id="tool_clear" class="menu_item">新建</div>
      <div id="tool_open" class="menu_item" style="display: none;"><div id="fileinputs"></div>打开 SVG 文件</div>
      <div id="tool_import" class="menu_item" style="display: none;"><div id="fileinputs_import"></div>导入图像</div>
      <div id="tool_save" class="menu_item">保存图像<span class="shortcut">⌘S</span></div>
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="edit_menu">
      ...
      <div class="menu_item action_selected disabled" id="tool_clone">重复<span class="shortcut">⌘D</span></div>
  ...
  <div class="menu">
    ...
    <div class="menu_list"  id="object_menu">
      <div class="menu_item action_selected disabled" id="tool_move_top">置于顶层<span class="shortcut">⌘⇧↑</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_bottom">置于底层<span class="shortcut">⌘⇧↓</span></div>
      ...
      <div class="separator"></div>
      <div class="menu_item action_path_convert_selected disabled" id="tool_topath">转换为路径</div>
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="view_menu">
        ...
        <div class="separator"></div> -->
        <div class="menu_item" id="tool_source">源代码<span class="shortcut">⌘U</span></div>
    </div>
  </div>
...
<div id="tools_top" class="tools_panel">
  ...
  <div id="canvas_panel" class="context_panel">
    ...
    <div class="draginput">
      ...
      <select id="resolution">
        ...
        <option id="fitToContent" value="content">适应内容大小</option>
      </select>
      <div class="caret"></div>
  ...
  <div id="text_panel" class="context_panel">
    ...
    <div class="toolset draginput select twocol" id="tool_font_family">
      ...
      <div class="tool_button" id="tool_bold" data-title="加粗 [B]">B</div>
      <div class="tool_button" id="tool_italic" data-title="倾斜 [I]">i</div>
    </div>

    <label id="tool_font_size" data-title="Change Font Size">
      <input id="font_size" size="3" value="0" />
      <span id="font_sizeLabel" class="icon_label">文字大小</span>
    </label>
  ...
  -->
    ...
    <div class="tool_button" id="tool_node_clone" title="添加节点">添加节点</div>
    <div class="tool_button" id="tool_node_delete" title="删除节点">删除节点</div>
    <div class="tool_button" id="tool_openclose_path" title="打开/关闭子路径">打开路径</div>
  ...
  <div id="selected_panel" class="context_panel">
    ...
    <label id="tool_angle" data-title="Change rotation angle" class="draginput">
      ...
      <label class="toolset" id="tool_opacity" data-title="Change selected item opacity">
        ...
        <span id="group_opacityLabel" class="icon_label">不透明</span>
      </label>
    ...
    <label id="cornerRadiusLabel" data-title="Change Rectangle Corner Radius">
      ...
      <span class="icon_label">圆角半径</span>
    </label>
      ...
      <div class="toolset align_buttons" id="tool_position">
          <label>
            <div class="col last clear" id="position_opts">
              ...
              <div class="draginput_cell" id="tool_poscenter" title="水平居中对齐"></div>
              <div class="draginput_cell" id="tool_posright" title="右对齐"></div>
              <div class="draginput_cell" id="tool_postop" title="顶部对齐"></div>
              <div class="draginput_cell" id="tool_posmiddle" title="垂直居中对齐"></div>
  ...
  <div id="multiselected_panel" class="context_panel clearfix">
    ...
    <div class="toolset align_buttons" style="position: relative">
      <label id="tool_align_relative" style="margin-top: 10px;"> 
        <select id="align_relative_to" title="相对对齐">
      ...
      <h4>.</h4>
        <div class="col last clear">
          ...
          <div class="draginput_cell" id="tool_aligncenter" title="水平居中对齐"></div>
          <div class="draginput_cell" id="tool_alignright" title="右对齐"></div>
          <div class="draginput_cell" id="tool_aligntop" title="顶部对齐"></div>
          <div class="draginput_cell" id="tool_alignmiddle" title="垂直居中对齐"></div>
          <div class="draginput_cell" id="tool_alignbottom" title="底部对齐"></div>
        </div>
    </div>
    <div class="clearfix"></div>
  ...
  <div id="stroke_panel" class="context_panel clearfix">
    ...
    <div class="toolset" data-title="Change stroke">
      <label>
        ...
        <span class="icon_label">笔画宽度</span>
      </label>
    </div>
...
<div id="tools_left" class="tools_panel">
  ...
  <div class="tool_button" id="tool_fhpath" title="画笔工具 [P]"></div>
  <div class="tool_button" id="tool_line" title="直线工具 [L]"></div>
  <div class="tool_button" id="tool_rect" title="矩形工具 [R]"></div>
  <div class="tool_button" id="tool_ellipse" title="椭圆工具 [C]"></div>
  <div class="tool_button" id="tool_path" title="路径工具 [P]"></div>
  <div class="tool_button" id="tool_text" title="文字工具 [T]"></div>
  <div class="tool_button" id="tool_zoom" title="缩放工具 [Z]"></div>
  
  <div id="color_tools">
        <div id="tool_switch" title="切换填充颜色 和 笔画颜色 [X]"></div>
        ...
        <div class="color_tool" id="tool_stroke">
          ...
          <div class="color_block">
            ...
            <div id="stroke_color" class="color_block" title="改变笔画颜色"></div>
          </div>
        </div>
  </div>
</div> <!-- tools_left -->
...
<div id="tools_bottom" class="tools_panel">
    ...
    <!-- Zoom buttons -->
  <div id="zoom_panel" class="toolset" title="缩放">
    <div class="draginput select" id="zoom_label">
      ...
      <div class="caret"></div>
      <input id="zoom" size="3" value="100%" type="text" readonly />
    </div>
  </div>

  <div id="tools_bottom_3">
    <div id="palette" title="吸取填充颜色 或 笔画颜色"></div>
  </div>
</div>
